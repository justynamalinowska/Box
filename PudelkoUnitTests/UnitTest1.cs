...
namespace PudelkoUnitTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        public void Constructor_3params_InMeters(double a, double b, double c,
                                                      double expectedA, double expectedB, double expectedC)
        {
            Pudelko p = new Pudelko(a, b, c, unitOfMeasure: UnitOfMeasure.meter);
        ...
        public void Constructor_3params_InCentimeters(double a, double b, double c,
                                                      double expectedA, double expectedB, double expectedC)
        {
            Pudelko p = new Pudelko(a: a, b: b, c: c, unitOfMeasure: UnitOfMeasure.centimeter);
        ...
        public void Constructor_3params_InMilimeters(double a, double b, double c,
                                                     double expectedA, double expectedB, double expectedC)
        {
            Pudelko p = new Pudelko(unitOfMeasure: UnitOfMeasure.milimeter, a: a, b: b, c: c);
        ...
        {
            Pudelko p = new Pudelko(a: a, b: b, unitOfMeasure: UnitOfMeasure.meter);
        ...
        {
            Pudelko p = new Pudelko(unitOfMeasure: UnitOfMeasure.centimeter, a: a, b: b);
        ...
        {
            Pudelko p = new Pudelko(unitOfMeasure: UnitOfMeasure.milimeter, a: a, b: b);
        ...
        {
            Pudelko p = new Pudelko(unitOfMeasure: UnitOfMeasure.centimeter, a: a);
        ...
        {
            Pudelko p = new Pudelko(unitOfMeasure: UnitOfMeasure.milimeter, a: a);
        ...
        {
            Pudelko p = new Pudelko(a, b, c, unitOfMeasure: UnitOfMeasure.centimeter);
        }
        ...
        {
            Pudelko p = new Pudelko(a, b, c, unitOfMeasure: UnitOfMeasure.milimeter);
        }
        ...
        {
            Pudelko p = new Pudelko(a, b, unitOfMeasure: UnitOfMeasure.meter);
        }
        ...
        {
            Pudelko p = new Pudelko(a, b, unitOfMeasure: UnitOfMeasure.centimeter);
        }
        ...
        {
            Pudelko p = new Pudelko(a, b, unitOfMeasure: UnitOfMeasure.milimeter);
        }
        ...
        {
            Pudelko p = new Pudelko(a, unitOfMeasure: UnitOfMeasure.milimeter);
        }
